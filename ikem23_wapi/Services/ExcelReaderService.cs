...
namespace ikem23_wapi.Services
{
    ...
    public class ExcelReaderService
    {
        ...
        public List<MolecularSequence> ReadMolecularSequences(string fileName, ImportTemplate template)
        {

            using Stream stream = new StreamReader(fileName).BaseStream;
            return ReadMolecularSequences(stream, template);
        }
        ...
        public List<MolecularSequence> ReadMolecularSequences(Stream stream, ImportTemplate template)
        {
